...
export const metadata: Metadata = {
  ...
  description: 'Looking for the best banquet hall in Seeduwa? Dinidu Gardens offers premium wedding reception halls in Sri Lanka with 500+ capacity, AC, and stunning garden views.',
